...
public class RelatesTo implements Externalizable, SafeSerializable {
    ...
    private List<OMAttribute> extensibilityAttributes = null;
    ...
    public List<OMAttribute> getExtensibilityAttributes() {
        return extensibilityAttributes;
    }

    public void setExtensibilityAttributes(List<OMAttribute> extensibilityAttributes) {
