...
public class PropertyMediatorTest extends TestCase {
    ...
    public void testTypeAwarePropertyHandling() throws Exception {
        ...
        SynapseMessageContext synCtx = MediatorUtils.createLightweightSynapseMessageContext("<empty/>");
        ...
        Axis2SynapseMessageContext axisCtx = (Axis2SynapseMessageContext)synCtx;
    ...
    public void testXMLPropertyHandling() throws Exception {
        ...
        OMElement valueOne = MediatorUtils.createOMElement(xml);
        propMediatorOne.setValueElement(valueOne);

        // Test setting XML properties
        SynapseMessageContext synCtx = MediatorUtils.getTestContext("<getQuote><symbol>IBM</symbol></getQuote>");
        propMediatorOne.mediate(synCtx);
