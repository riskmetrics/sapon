...
public class SOAP12HeaderImpl extends SOAPHeaderImpl {
    ...
    @Override
	public Iterable<SOAPHeaderBlock> extractHeaderBlocks(String role) {
        return new OMFilterIterator<SOAPHeaderBlock>(new OMChildrenWithSpecificAttributeIterator(getFirstOMChild(),
                                                           new QName(
