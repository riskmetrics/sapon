...
public class MediatorWorker implements Runnable {
     ...
     */
    public MediatorWorker(Mediator seq, SynapseMessageContext synCtx) {
        this.seq = seq;
        this.synCtx = synCtx;
    }
     ...
     * @param synCtx - Synapse MessageContext to be set
     */
    public MediatorWorker(SynapseMessageContext synCtx) {
        this.synCtx = synCtx;
    ...
    private void warn(boolean traceOn, String msg, SynapseMessageContext msgContext) {
        if (traceOn) {
            trace.warn(msg);
        }
