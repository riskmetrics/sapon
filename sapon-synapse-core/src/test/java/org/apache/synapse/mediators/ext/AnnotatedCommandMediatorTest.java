...
public class AnnotatedCommandMediatorTest extends AbstractMediatorTestCase {
    ...
    public void testBasicExecute() throws Exception {
        ...
        SynapseMessageContext mc = MediatorUtils.getTestContext("<m:getQuote xmlns:m=\"http://services.samples/xsd\"><m:request><m:symbol>IBM</m:symbol></m:request></m:getQuote>");
        pcm.mediate(mc);
