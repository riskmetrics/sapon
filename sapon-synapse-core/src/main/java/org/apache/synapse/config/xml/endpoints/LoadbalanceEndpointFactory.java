        ...
        if (loadbalanceElement != null) {
            ...
            if (loadbalanceElement.getFirstChildWithName(XMLConfigConstants.ENDPOINT_ELT) != null) {
                if(loadbalanceElement.
                        getChildrenWithName((MEMBER)).iterator().hasNext()){
                    String msg =
                ...
                if(loadbalanceElement.
                        getChildrenWithName((XMLConfigConstants.ENDPOINT_ELT)).iterator().hasNext()){
                    String msg =
                            "Invalid Synapse configuration. " +
                            "loadbalanceEndpoint element cannot have both member & endpoint " +
                            "child elements";
...
//        for(OMElement memberEle: loadbalanceElement.getChildrenWithName(MEMBER)) {
