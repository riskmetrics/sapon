...
{
    private RequestURIBasedOperationDispatcher operationDispatcher
    	= new RequestURIBasedOperationDispatcher();
	...
	public AxisService findService(MessageContext messageContext)
    	throws AxisFault
    {
        // This Dispatcher does not need to resolve the service; that's handled
