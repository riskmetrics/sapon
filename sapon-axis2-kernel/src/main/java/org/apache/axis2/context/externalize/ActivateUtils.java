...
public class ActivateUtils {
    ...
    public static AxisService findService(AxisConfiguration axisConfig, String serviceClassName,
        ...
        for(final AxisService service: services.values()) {
    ...
    public static AxisOperation findOperation(AxisConfiguration axisConfig, String opClassName,
        ...
        for(final AxisService service: services.values()) {
            for(final AxisOperation operation: service.getOperations()) {
    ...
    public static AxisOperation findOperation(AxisService service, String opClassName,
        ...
        // Previous versions of Axis2 didn't use a namespace on the operation
        // name, so they wouldn't have externalized a namespace.  If that's the
        // case, only compare the localPart of the operation name
    ...
    public static TransportListener findTransportListener(AxisConfiguration axisConfig,
        ...
        final Map<String, TransportInDescription> transportsIn
        	= axisConfig.getTransportsIn();

        for(final TransportInDescription ti: transportsIn.values()) {
     ...
     *         FALSE, otherwise
     */
    public static <T1, T2> boolean isEquivalent(List<T1> a1, List<T2> a2, boolean strict) {
        if ((a1 != null) && (a2 != null)) {
     ...
     *         FALSE, otherwise
     */
    public static <K, V> boolean isEquivalent(	Map<? extends K, ? extends V> m1,
    											...
    											boolean strict)
    {
        if ((m1 != null) && (m2 != null)) {
            if (strict) {
                ...
                Iterator<? extends K> it1 = m1.keySet().iterator();
     ...
     *         FALSE, otherwise
     */
    public static <T> boolean isEquivalent(	LinkedList<? extends T> l1,
    										LinkedList<? extends T> l2) {
        if ((l1 != null) && (l2 != null)) {
            // This is a strict test.
