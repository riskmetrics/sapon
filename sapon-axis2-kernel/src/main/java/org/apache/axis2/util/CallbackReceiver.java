...
public class CallbackReceiver implements MessageReceiver {
    ...
    private ConcurrentHashMap<String, AxisCallback> callbackStore;

    public CallbackReceiver() {
        callbackStore = new ConcurrentHashMap<String, AxisCallback>();
    }
     ...
     */
    private final void putIfAbsent(String msgID, AxisCallback callback) throws AxisFault {
    ...
    public AxisCallback lookupCallback(String msgID) {
		AxisCallback o = callbackStore.remove(msgID);
    ...
    public Map<String, AxisCallback> getCallbackStore() {
