...
public abstract class AbstractWSDLElement implements WSDLElement
{
  ...
  protected List<ExtensibilityElement> extElements
  	= new Vector<ExtensibilityElement>();
  protected Map<QName, List<QName>> extensionAttributes
   ...
   * @param value the extension attribute value as a list of QNames.
   *
