...
public class TextMessageBuilderAdapter implements TextMessageBuilder {
    ...
    public OMElement getDocumentElement(InputStream inputStream, String contentType,
        ...
        return builder.getDocumentElement(inputStream, contentType, messageContext);
    }

    public OMElement getDocumentElement(Reader reader, String contentType,
                                     MessageContext messageContext) throws AxisFault {
        String charset;
        try {
    ...
    public OMElement getDocumentElement(String content, String contentType,
                                     MessageContext messageContext) throws AxisFault {
        return getDocumentElement(new StringReader(content), contentType, messageContext);
    }
}
