...
public class SwitchMediatorFactory extends AbstractMediatorFactory {
    ...
    public Mediator createMediator(OMElement elem) {
        ...
        for(OMElement caseElem: elem.getChildrenWithName(CASE_Q)) {
        ...
        for(OMElement e: elem.getChildrenWithName(DEFAULT_Q)) {
            SwitchCase aCase = new SwitchCase();
            aCase.setCaseMediator(AnonymousListMediatorFactory.createAnonymousListMediator(e));
