...
public class GetPropertyFunction implements Function {
    ...
    private final SynapseMessageContext synCtx;

    public GetPropertyFunction(SynapseMessageContext synCtx) {
        this.synCtx = synCtx;
    }
    ...
    public Object evaluate(Object scopeObject, Object keyObject, Object dateformat,Navigator navigator) {
        ...
        if (XMLConfigConstants.SCOPE_DEFAULT.equals(scope)) {
            ...
            if (SynapseConstants.HEADER_TO.equals(key)) {
                ...
                } else if (synCtx instanceof Axis2SynapseMessageContext) {
                ...
                if (synCtx instanceof Axis2SynapseMessageContext) {
                    AxisOperation axisOperation
                        = ((Axis2SynapseMessageContext)synCtx).getAxis2MessageContext().getAxisOperation();
