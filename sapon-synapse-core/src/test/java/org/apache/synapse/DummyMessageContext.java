...
public class DummyMessageContext implements SynapseMessageContext {
    ...
    public DummyMessageContext(SynapseConfiguration testConfig, SynapseEnvironment synEnv) {
    	this.synCfg = testConfig;
    	this.synEnv = synEnv;
    }
    ...
    public Log getServiceLog() {
        return LogFactory.getLog(DummyMessageContext.class);
    }
