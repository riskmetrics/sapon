...
public class SafeObjectOutputStream implements ObjectOutput,
    ...
    public static final Hashtable<String, String> notSerializableList
     ...
     * @throws IOException
     */
    public <K,V> boolean writeMap(Map<K,V> map) throws IOException {
     ...
     * @throws IOException
     */
    public <T> boolean writeList(List<T> al) throws IOException {
        if (al == null) {
            out.writeBoolean(EMPTY_OBJECT);
            return false;
        } else {
