...
public abstract class AbstractHTTPSender {
    ...
    protected void obtainHTTPHeaderInformation(HttpMethodBase method,
        ...
        if (header != null) {
            ...
            for (HeaderElement header2 : headers) {
                NameValuePair charsetEnc = header2.getParameterByName(
...
//                        }
    ...
    private String getUserAgent(MessageContext messageContext) {
        ...
        if (messageContext.getParameter(HTTPConstants.USER_AGENT) != null) {
        	Object obj = messageContext.getParameter(HTTPConstants.USER_AGENT).getValue();
            if(obj instanceof OMElement) {
            	OMElement userAgentElement = (OMElement) obj;
