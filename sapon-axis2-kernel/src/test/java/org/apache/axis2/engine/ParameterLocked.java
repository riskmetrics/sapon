...
public class ParameterLocked extends TestCase {
    ...
    String repo = getClass().getResource("/deployment/ParaLockedRepo").getFile();


    @Override
	protected void setUp() throws Exception {
        ar = ConfigurationContextFactory
                .createConfigurationContextFromFileSystem(repo, repo + "/axis2.xml")
    ...
    public void testOveride_Non_locked_Para_Service() {
        try {
            ...
            ServiceBuilder sbuilder = new ServiceBuilder(in, new ConfigurationContext(ar), service);
