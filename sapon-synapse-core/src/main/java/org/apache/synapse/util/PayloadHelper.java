...
public class PayloadHelper {
	...
	public static int getPayloadType(SynapseMessageContext mc) {
	...
	public static void setXMLPayload(SOAPEnvelope envelope, OMElement element) {
		...
		if (body == null) {
			...
			for(OMNode node: body.getChildren()) {
				node.discard();
			}
		}
	...
	public static void setXMLPayload(SynapseMessageContext mc, OMElement element) {
		if (mc.getEnvelope() == null) {
			try {
	...
	public static DataHandler getBinaryPayload(SynapseMessageContext mc) {
		if (mc.getEnvelope() == null) {
	...
	public static void setBinaryPayload(SynapseMessageContext mc, DataHandler dh) {
		if (mc.getEnvelope() == null) {
			try {
				mc.setEnvelope(OMAbstractFactory.getSOAP12Factory()
						.createSOAPEnvelope());
	...
	public static String getTextPayload(SynapseMessageContext mc) {
		if (mc.getEnvelope() == null) {
			log.error("null envelope");
			return null;
		}
	...
	public static void setTextPayload(SynapseMessageContext mc, String text) {
		if (mc.getEnvelope() == null) {
			try {
				mc.setEnvelope(OMAbstractFactory.getSOAP12Factory()
						.createSOAPEnvelope());
	...
	public static SimpleMap getMapPayload(SynapseMessageContext mc) {
		if (mc.getEnvelope() == null) {
			log.error("null envelope");
			return null;
		}
	...
	public static void setMapPayload(SynapseMessageContext mc, SimpleMap map) {
		if (mc.getEnvelope() == null) {
			try {
				mc.setEnvelope(OMAbstractFactory.getSOAP12Factory()
						.createSOAPEnvelope());
	...
	public static XMLStreamReader getStAXPayload(SynapseMessageContext mc) {
		if (mc.getEnvelope() == null) {
			log.error("null envelope");
			return null;
		}
	...
	public static void setStAXPayload(SynapseMessageContext mc, XMLStreamReader streamReader) {
		if (mc.getEnvelope() == null) {
			try {
				mc.setEnvelope(OMAbstractFactory.getSOAP12Factory()
						.createSOAPEnvelope());
