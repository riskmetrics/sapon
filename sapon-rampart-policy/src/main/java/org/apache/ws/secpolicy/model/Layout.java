...
public class Layout extends AbstractSecurityAssertion {
    ...
    public void serialize(XMLStreamWriter writer) throws XMLStreamException {
        ...
        if (SPConstants.LAYOUT_STRICT.equals(value)) {
            writer.writeStartElement(namespaceURI, SPConstants.LAYOUT_STRICT);

        } else if (SPConstants.LAYOUT_LAX.equals(value)) {
            writer.writeStartElement(namespaceURI, SPConstants.LAYOUT_LAX);

        } else if (SPConstants.LAYOUT_LAX_TIMESTAMP_FIRST.equals(value)) {
            writer.writeStartElement(namespaceURI, SPConstants.LAYOUT_LAX_TIMESTAMP_FIRST);

        } else if (SPConstants.LAYOUT_LAX_TIMESTAMP_LAST.equals(value)) {
            writer.writeStartElement(namespaceURI, SPConstants.LAYOUT_LAX_TIMESTAMP_LAST);
        }
