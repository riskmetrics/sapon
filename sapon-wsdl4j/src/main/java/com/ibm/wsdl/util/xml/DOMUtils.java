...
public class DOMUtils {
   ...
   */
  static public List<Attr> getAttributes (Element el) {
   ...
   * @return the attribute value
   */
  static public String getAttribute (Element el, String attrName, List<Attr> remainingAttrs) {
    String sRet = null;
    Attr   attr = el.getAttributeNode(attrName);
                                 ...
                                 throws WSDLException
  {
    ...
    {
      return new QName(null, prefixedValue);
...
//      throw wsdlExc;
                                          ...
                                          Definition def)
  {
     ...
     */
    Collection<String> nSpaces = def.getNamespaces().values();
