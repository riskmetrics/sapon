...
public class OperationModuleTest extends TestCase {
    ...
    public void testOperationModule() throws Exception {
    	URL configCtxDirURL = getClass().getResource("/deployment/AxisMessageTestRepo");
        ConfigurationContext configCtx =
                ConfigurationContextFactory.createConfigurationContextFromFileSystem(
                		configCtxDirURL.getFile());
        ...
        List<String> moduleRefs = operation.getModuleRefs();
        assertEquals("Wrong # of modules", 1, moduleRefs.size());
        String moduleName = moduleRefs.get(0);
