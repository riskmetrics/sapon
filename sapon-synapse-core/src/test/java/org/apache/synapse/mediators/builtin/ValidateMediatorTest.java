...
public class ValidateMediatorTest extends TestCase {
    ...
    private void test(ValidateMediator validate, SynapseMessageContext synCtx, boolean expectFail) {
        final BoolHolder onFailInvoked = new BoolHolder();
    ...
    public void testValidateMediatorValidCase() throws Exception {
        ...
        SynapseMessageContext synCtx = new DummyMessageContextBuilder()
                .addFileEntry("xsd-key", getClass().getResource("/conf/sample/resources/validate/validate.xsd").getFile())
    ...
    public void testValidateMediatorValidCaseTwoSchemas() throws Exception {
        ...
        SynapseMessageContext synCtx = new DummyMessageContextBuilder()
                .addFileEntry("xsd-key-1", getClass().getResource("/conf/sample/resources/validate/validate.xsd").getFile())
                .addFileEntry("xsd-key-2", getClass().getResource("/conf/sample/resources/validate/validate2.xsd").getFile())
