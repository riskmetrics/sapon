...
/**
 * This class is just to test the behaviour of the POJO Command when
 * implemented by implementing the Command interface. This will use static
 * members to accomplish the test tasks.
 */
