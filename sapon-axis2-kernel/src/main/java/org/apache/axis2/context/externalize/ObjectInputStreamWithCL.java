...
public class ObjectInputStreamWithCL extends java.io.ObjectInputStream
{
    ...
    private Class<?> resolveClass(String name) throws ClassNotFoundException
    {
        ...
        {
            this.name = name;
            return AccessController.doPrivileged(loadAction);
        }
    ...
    PrivilegedExceptionAction<Class<?>> loadAction =
	...
	protected Class<?> resolveProxyClass(String[] interfaces) throws ClassNotFoundException
    {
        ...
        final ClassLoader loader = AccessController.doPrivileged(proxyClassLoaderAction);
    ...
    PrivilegedAction<ClassLoader> proxyClassLoaderAction = new PrivilegedAction<ClassLoader>()
    {
        public ClassLoader run()
        {
