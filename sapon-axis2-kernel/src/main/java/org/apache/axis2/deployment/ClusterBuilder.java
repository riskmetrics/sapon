...
public class ClusterBuilder extends DescriptionBuilder {
    ...
    private void loadApplicationDomains(ClusterManager clusterManager,
        ...
        if (lbEle != null) {
            ...
            for(OMElement omElement: lbEle.getChildrenWithName(new QName("applicationDomain"))) {
    ...
    private void loadWellKnownMembers(ClusterManager clusterManager, OMElement clusterElement) {
        ...
        if (membershipSchemeParam != null) {
            ...
            if (membershipScheme.equals(ClusteringConstants.MembershipScheme.WKA_BASED)) {
                ...
                if (membersEle != null) {
                    for(OMElement memberEle: membersEle.getChildrenWithLocalName("member")) {
                        String hostName =
        ...
        if (contextManagerEle != null) {
            ...
            if (replicationEle != null) {
                ...
                if (defaultsEle != null) {
                    ...
                    for(OMElement excludeEle: defaultsEle.getChildrenWithName(new QName(TAG_EXCLUDE))) {
                ...
                // Process specifics
                for(OMElement contextEle: replicationEle.getChildrenWithName(new QName(TAG_CONTEXT))) {
                    String ctxClassName
                    	= contextEle.getAttribute(new QName(ATTRIBUTE_CLASS)).getAttributeValue();
                    List<String> excludes = new ArrayList<String>();
                    for(OMElement excludeEle: contextEle.getChildrenWithName(new QName(TAG_EXCLUDE))) {
                        OMAttribute nameAtt = excludeEle.getAttribute(new QName(ATTRIBUTE_NAME));
