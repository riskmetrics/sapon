...
public class ExcludeInfo {
    ...
    private Map<String, BeanExcludeInfo> classNameToBeanInfoMap
    	= new HashMap<String, BeanExcludeInfo>();
    ...
    public BeanExcludeInfo getBeanExcludeInfoForClass(String className){
        ...
        for (Object element : this.classNameToBeanInfoMap.keySet()) {
             classNameRegx = (String) element;
             if (className.matches(classNameRegx)){
                 beanExcludeInfo = this.classNameToBeanInfoMap.get(classNameRegx);
