...
public class DOM2Writer
{
  ...
  private static Map<String, String> xmlEncodingMap
  ...
  {
    return nodeToString(node, new HashMap<String, String>());
  }
  ...
  {
    serializeElementAsDocument(el, new HashMap<String, String>(), writer);
  }
  ...
  */
  ...
  {
    serializeAsXML(node, new HashMap<String, String>(), writer);
  }
  ...
  */
  ...
  {
    return xmlEncodingMap.get(javaEnc);
  }
