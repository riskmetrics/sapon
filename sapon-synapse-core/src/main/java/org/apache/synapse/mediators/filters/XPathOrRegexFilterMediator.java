	...
	implements FilterMediator
{
	...
	public boolean mediate(SynapseMessageContext synCtx) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Start : Filter mediator");
    ...
    public boolean test(SynapseMessageContext synCtx) {
        ...
        if (xpath != null) {
            ...
            if (sourceString == null) {
                if (log.isDebugEnabled()) {
                    log.debug("Source String : " + source + " evaluates to null");
                }
                return false;
            }
            ...
            if (matcher == null) {
                if (log.isDebugEnabled()) {
                    log.debug("Regex pattern matcher for : " + regex.pattern() +
