...
/**
 * Provides a convenient way to create a server and deploy services.
 * The start method fires up a configuration context and the configured
 * listeners.
 */
public class AxisServer {
    ...
    /**
     * If you do not want Axis2 to start the server automatically then pass
     * "false" else "true"
     *
