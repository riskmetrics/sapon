...
/**
 * Test the setting of properties on an Context instance.  Note that MessageContext is used
 * in most of the tests as the concrete implementation of Context.  Some tests also test
 * the HashTableUpdateLockable collection used in Context.proeprties directly.
 */
public class ContextPropertiesTest extends TestCase {
    ...
    public void testHashMapUpdateLockable() {
        ...
        HashMapUpdateLockable<String, String> testMap
        	= new HashMapUpdateLockable<String, String>();
        ...
        HashMapUpdateLockable<String, String> testCtorMap
        	= new HashMapUpdateLockable<String, String>(map);
    ...
    private static int THREAD_TIMEOUT = 5000;
    ...
    // was blocked. (But not so long that the tests are annoying to run).
    private static int LOCK_THREAD_SLEEP = 1000;
    ...
    abstract class UpdateLockableTestRunnable implements Runnable {
        ...
        HashMapUpdateLockable<String, String> testMap = null;
    }
