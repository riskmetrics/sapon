...
public class AsyncCallback implements AxisCallback {
    ...
    private final SynapseMessageContext synapseOutMsgCtx;
    ...
    public AsyncCallback(SynapseMessageContext synapseOutMsgCtx) {
    ...
    public org.apache.synapse.SynapseMessageContext getSynapseOutMsgCtx() {
