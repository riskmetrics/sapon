...
/**
 * Test the externalization of properties on a Context.  Since each of the Context
...
public class ContextPropertiesExternalizeTest extends TestCase {
    ...
    public void testExternalizeMessageContext() {
        ...
        assertTrue(mc.getProperties() instanceof Map<?,?>);
        assertEquals(5, mc.getProperties().size());
        ...
        try {
            ...
            MessageContext mcRead = new OldMessageContext();
            mcRead.readExternal(ois);

            assertEquals(5, mcRead.getProperties().size());
            ...
            assertTrue(mcRead.getProperties() instanceof Map<?,?>);
    ...
    public void testExternalizeOperationContext() {
        ...
        assertTrue(ctx.properties instanceof Map<?,?>);
        ...
        try {
            ...
            assertTrue(ctxRead.properties instanceof Map<?,?>);
    ...
    public void testExternalizeSessionContext() {
        SessionContext<?> ctx = new SessionContext<SessionContext<?>>();
        ...
        try {
            ...
            SessionContext<?> ctxRead = new SessionContext<SessionContext<?>>();
            ctxRead.readExternal(ois);
