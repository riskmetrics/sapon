...
public class Axis2Sender {
     ...
     */
    public static void sendBack(org.apache.synapse.SynapseMessageContext smc) {

        MessageContext messageContext = ((Axis2SynapseMessageContext) smc).getAxis2MessageContext();
