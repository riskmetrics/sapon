...
public class ClassMediatorSerializationTest extends AbstractTestCase {
    ...
    public void testClassMediatorSerializationSenarioOne() throws Exception {
        String inputXml = "<class xmlns=\"http://ws.apache.org/ns/synapse\" name=\"org.apache.synapse.config.xml.DummyMediator\"></class> ";
    ...
    public void testClassMediatorSerializationWithProperty() throws Exception {
        String inputXml = "<class xmlns=\"http://ws.apache.org/ns/synapse\" name=\"org.apache.synapse.config.xml.DummyMediator\"><property name=\"testProp\" value=\"This is a test\"/></class> ";
        assertTrue(serialization(inputXml, classMediatorFactory, classMediatorSerializer));
        assertTrue(serialization(inputXml, classMediatorSerializer));
    }

    public void testClassMediatorSerializationWithInlineProperty() throws Exception {
        String inputXml = "<class xmlns=\"http://ws.apache.org/ns/synapse\" name=\"org.apache.synapse.config.xml.DummyMediator\"><property name=\"testElemProp\"><test/></property></class> ";
        assertTrue(serialization(inputXml, classMediatorFactory, classMediatorSerializer));
        assertTrue(serialization(inputXml, classMediatorSerializer));
    }
