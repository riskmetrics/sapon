...
//                              OMNamespace whttp, String interfaceName,
...
//            }
//            List<SOAPModuleMessage> soapModules = (List<SOAPModuleMessage>)options.get(WSDL2Constants.ATTR_WSOAP_MODULE);
...
//                AxisBindingMessage axisBindingFault = iterator.next();
//                OMElement omElement =
...
//        for(final AxisBindingOperation axisBindingOperation: getChildren()) {
...
//    }
	...
	public Iterable<AxisBindingOperation> getChildren(){
    	return (Iterable<AxisBindingOperation>) super.getChildren();
    }
}
