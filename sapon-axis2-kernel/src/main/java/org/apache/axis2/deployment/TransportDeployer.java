...
public class TransportDeployer implements Deployer {
    ...
    public void deploy(DeploymentFileData deploymentFileData) throws DeploymentException {
        ...
        try {
            ...
            List<TransportInDescription> transportReceivers = builder.processTransportReceivers(trs_Reivers);
            for(TransportInDescription transportInDescription: transportReceivers) {
