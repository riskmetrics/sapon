...
public interface SOAPHeader extends OMElement {
     ...
     */
    Iterable<SOAPHeaderBlock> getHeadersToProcess(RolePlayer rolePlayer);
     ...
     * @return Returns an <CODE>Iterable</CODE> object over all the <CODE> SOAPHeaderBlock</CODE>
     *         objects that contain the specified role
     * @see #extractHeaderBlocks(String) extractHeaderBlocks(java.lang.String)
     */
    Iterable<SOAPHeaderBlock> examineHeaderBlocks(String role);
     ...
     */
    Iterable<SOAPHeaderBlock> extractHeaderBlocks(String role);
     ...
     */
    Iterable<SOAPHeaderBlock> examineMustUnderstandHeaderBlocks(String role);

    /**
     * Returns an <code>Iterable</code> over all the <code>SOAPHeaderBlock</code> objects in this
     * <code>SOAPHeader</code> object.
     *
     * @return an <code>Iterable</code> object over all the <code>SOAPHeaderBlock</code> objects
     *         contained by this <code>SOAPHeader</code>. If there are no header blocks then an
     *         empty Iterable is returned.
     */
    Iterable<SOAPHeaderBlock> examineAllHeaderBlocks();
     ...
     */
    Iterable<SOAPHeaderBlock> extractAllHeaderBlocks();

    /**
     * Return all the Headers that has the Namespace URI to given NS URI.
     *
     * TODO: why does this return List when everything else returns Iterable?
     *
     * @param nsURI
     * @return Returns List.
     */
    List<SOAPHeaderBlock> getHeaderBlocksWithNSURI(String nsURI);
     ...
     * @return an Iterable over all the HeaderBlocks this RolePlayer should process.
     */
    Iterable<SOAPHeaderBlock> getHeadersToProcess(RolePlayer rolePlayer, String namespace);
}
