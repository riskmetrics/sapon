 ...
 */
public class OMQualifiedNameFilterIterator extends OMFilterIterator<OMElement> {
    private final String prefix;
    private final String localName;

    public OMQualifiedNameFilterIterator(Iterator<OMNode> parent, String qualifiedName) {
        super(parent);
	...
	protected OMElement matches(OMNode node) {
        if (node instanceof OMElement) {
            ...
            if (localName.equals(element.getLocalName())) {
                ...
                } else if (ns != null && prefix.equals(ns.getPrefix())) {
                	return (OMElement)node;
                }
            }
        }
