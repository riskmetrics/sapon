...
public class MediatorFaultHandler extends FaultHandler {
     ...
     * @see org.apache.synapse.FaultHandler#handleFault(org.apache.synapse.SynapseMessageContext)
     */
    @Override
	public void onFault(SynapseMessageContext synCtx) throws SynapseException {
