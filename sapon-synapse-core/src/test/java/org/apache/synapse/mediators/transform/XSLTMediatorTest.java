...
public class XSLTMediatorTest extends TestCase {
    ...
    public static TestSuite suite() {
        ...
        addGenericTests(suite, "Xalan", TransformerFactoryImpl.class);
    ...
    private static void addGenericTests(TestSuite suite, final String processorName,
            final Class<?> transformerFactoryClass) {
    ...
    public void testTransformXSLTCustomSource() throws Exception {
        ...
        SynapseMessageContext synCtx = new DummyMessageContextBuilder().addFileEntry("xslt-key",
                getClass().getResource("/conf/sample/resources/transform/transform_unittest.xslt").getFile())
    ...
    public void testTransformXSLTDefaultSource() throws Exception {
        ...
        // create a new xslt mediator
        XSLTMediator transformMediator = new XSLTMediator();
   	 	transformMediator.setSource(SourceXPathSupport.BODY_XPATH);
...
//            SynapseMessageContext synCtx = new TestMessageContextBuilder().addFileEntry("xslt-key",
//                    getClass().getResource("/conf/sample/resources/transform/transform_load.xml").getFile())
//                    .setBodyFromFile(getClass().getResource("/conf/sample/resources/transform/message.xml").getFile())
...
//            // invoke transformation, with static enveope
//            SynapseMessageContext synCtx = new TestMessageContextBuilder().addFileEntry("xslt-key",
//                    getClass().getResource("/conf/sample/resources/transform/transform_load_3.xml").getFile())
//                    .setBodyFromFile(getClass().getResource("/conf/sample/resources/transform/message.xml").getFile())
//                    .addTextAroundBody().build();
//            //MessageContext synCtx = TestUtils.getTestContextForXSLTMediator(SOURCE, props);
//            transformMediator.mediate(synCtx);
...
//    }
     ...
     public void testSynapse242() throws Exception {
         ...
         // invoke transformation, with static enveope
         SynapseMessageContext synCtx = new DummyMessageContextBuilder().addFileEntry("xslt-key",
                 getClass().getResource("/conf/sample/resources/transform/transform_load_2.xml").getFile())
                 .setBodyFromFile(getClass().getResource("/conf/sample/resources/transform/med_message.xml").getFile())
                 .addTextAroundBody().build();
         transformMediator.mediate(synCtx);
    ...
    public void testTransformXSLTSmallMessages() throws Exception {
        ...
        for (int i=0; i<5; i++) {
            ...
            SynapseMessageContext synCtx = new DummyMessageContextBuilder().addFileEntry("xslt-key",
                    getClass().getResource("/conf/sample/resources/transform/transform_load_2.xml").getFile())
                    .setBodyFromFile(getClass().getResource("/conf/sample/resources/transform/small_message.xml").getFile())
                    .addTextAroundBody().build();
            //MessageContext synCtx = TestUtils.getTestContextForXSLTMediator(SOURCE, props);
            transformMediator.mediate(synCtx);
            //System.out.println("done : " + i + " :: " + Runtime.getRuntime().freeMemory());
    ...
    public void testTextEncoding() throws Exception {
        ...
        SynapseMessageContext mc = new DummyMessageContextBuilder().addFileEntry("xslt-key",
                getClass().getResource("/conf/sample/resources/transform/encoding_test.xslt").getFile())
                .setEnvelopeFromFile(getClass().getResource("/conf/sample/resources/transform/encoding_test.xml").getFile())
                        .build();
    ...
    public void testInvalidStylesheet() throws Exception {
        ...
        SynapseMessageContext mc = new DummyMessageContextBuilder()
