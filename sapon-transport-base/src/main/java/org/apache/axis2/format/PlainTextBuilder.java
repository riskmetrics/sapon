...
public class PlainTextBuilder implements TextMessageBuilder, DataSourceMessageBuilder {
    ...
    public OMElement getDocumentElement(Reader reader,
                                     String contentType,
                                     MessageContext msgContext) throws AxisFault {
    ...
    public OMElement getDocumentElement(String content,
                                     String contentType,
                                     MessageContext msgContext) throws AxisFault {
        OMFactory factory = OMAbstractFactory.getOMFactory();
    ...
    public OMElement getDocumentElement(DataSource dataSource,
                                     String contentType,
                                     MessageContext msgContext) throws AxisFault {
