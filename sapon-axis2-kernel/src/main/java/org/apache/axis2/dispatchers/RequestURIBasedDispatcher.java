...
public class RequestURIBasedDispatcher extends AbstractDispatcher {
    ...
    private RequestURIBasedServiceDispatcher serviceDispatcher
	...
	public AxisOperation findOperation(AxisService service, MessageContext messageContext)
    	throws AxisFault
    {
        // This Dispatcher does not need to resolve the operation; that's
    	// handled by RequestURIOperationDispatcher.
        return null;
    }
