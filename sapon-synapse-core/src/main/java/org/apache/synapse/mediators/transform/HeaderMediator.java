...
public class HeaderMediator extends AbstractMediator {
    ...
    public boolean mediate(SynapseMessageContext synCtx) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Start : Header mediator");
        ...
        if (action == ACTION_SET) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("Set SOAP header : " + qName + " to : " + value);
            }
            ...
            if (log.isDebugEnabled()) {
                log.debug("Removing SOAP Header : " + qName);
            }
        ...
        log.debug("End : Header mediator");
        return true;
    }

    private void addCustomHeader(SynapseMessageContext synCtx, String value) {
