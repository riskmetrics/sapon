...
public interface ContextManager extends ParameterInclude {
    ...
    /**
     * This method is called when properties in an {@link Context} are updated.
     ...
     */
    void updateContext(Context context) throws ClusteringFault;

    /**
     * This method is called when one need to update/replicate only certains properties in the
     * specified <code>context</code>
     *
     * @param context       The Context containing the properties to be replicated
     * @param propertyNames The names of the specific properties that should be replicated
     * @throws ClusteringFault If replication fails
     */
    void updateContext(Context context, String[] propertyNames) throws ClusteringFault;

    /**
     * This method is called when properties in a collection of {@link Context}s are updated.
     * This could be addition of new properties, modifications of existing properties or
     * removal of properties.
     *
     * @param contexts The Contexts containing the properties to be replicated
     * @throws ClusteringFault If replication fails
     */
    void updateContexts(Context[] contexts) throws ClusteringFault;

    /**
     * This method is called when {@link Context} is removed from the system
     *
     * @param context The Context to be removed
     * @throws ClusteringFault If context removal fails
     */
    void removeContext(Context context) throws ClusteringFault;

    /**
     * This is a check to see whether the properties in an instance of {@link Context}
     ...
     *
     * @param context The instance of Context under consideration
     * @return True - if the provided {@link Context}  is clusterable
     */
    boolean isContextClusterable(Context context);
     ...
     */
    void setReplicationExcludePatterns(String contextType, List<String> patterns);
     ...
     */
    Map<String, List<String>> getReplicationExcludePatterns();
}
