...
public class MultiParentClassLoader extends URLClassLoader {
    ...
    private boolean isNonOverridableClass(String name) {
        for (String nonOverridableClasse : nonOverridableClasses) {
            if (name.startsWith(nonOverridableClasse)) {
                return true;
            }
        }
        return false;
    ...
    private boolean isHiddenClass(String name) {
        for (String hiddenClasse : hiddenClasses) {
            if (name.startsWith(hiddenClasse)) {
                return true;
            }
        }
        return false;
