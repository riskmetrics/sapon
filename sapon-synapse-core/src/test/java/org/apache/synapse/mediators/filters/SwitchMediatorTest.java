...
public class SwitchMediatorTest extends TestCase {
    ...
    DummyMediator ibmMediator, msftMediator, defaultMediator;
    SwitchMediator switchMediator = null;

    public void setUp() throws Exception {

        ibmMediator = new DummyMediator();
        ...
        msftMediator = new DummyMediator();
        ...
        defaultMediator = new DummyMediator();
    ...
    public void testSwitchConditionCaseOne() throws Exception {
        ...
        switchMediator.mediate(MediatorUtils.getTestContext(IBM_REQ));
    ...
    public void testSwitchConditionCaseTwo() throws Exception {
        ...
        // test switch mediator, with static enveope
        switchMediator.mediate(MediatorUtils.getTestContext(MSFT_REQ));
    ...
    public void testSwitchConditionCaseDefault() throws Exception {
        ...
        // test switch mediator, with static enveope
        switchMediator.mediate(MediatorUtils.getTestContext(DEFAULT_REQ));
