 ...
 */
public abstract class AbstractContext<P extends Context<?>> implements Context<P>
{
    ...
    protected AbstractContext(P parent) {
        this.parent = parent;
    }
     ...
     */
    public boolean isAncestor(Context<?> context) {
        if (context == null) {
            return false;
        }
        for (Context<?> ancestor = getParent();
            ancestor != null;
    ...
    public Object getProperty(String key) {
        ...
        if (obj!=null) {
            ...
            // i.e. The object pointed to by 'value' may be modified after it
        	// is read
     ...
     * @param context
     */
    public void setParent(P context) {
        parent = context;
    }
...
class HashMapUpdateLockable<K, V> extends HashMap<K, V> {
    ...
    private final UpdateLock updateLock = new UpdateLock(false);
