...
public class SchemaConstants {
    ...
    public static final List<QName> XSD_QNAME_LIST = Arrays.asList(new QName[]
    ...
    public static final List<QName> XSD_IMPORT_QNAME_LIST = Arrays.asList(new QName[]
    ...
    public static final List<QName> XSD_INCLUDE_QNAME_LIST = Arrays.asList(new QName[]
    ...
    public static final List<QName> XSD_REDEFINE_QNAME_LIST = Arrays.asList(new QName[]
