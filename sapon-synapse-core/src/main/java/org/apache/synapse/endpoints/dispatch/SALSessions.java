...
public class SALSessions {
     ...
     */
    public void updateSession(SynapseMessageContext synCtx, String sessionID) {
    ...
    */
     ...
     */
    private SessionInformation createSessionInformation(SynapseMessageContext synCtx, String id, List<Endpoint> endpoints) {
