...
public class SchemaImpl implements Schema
{
   ...
   * setting.
   */
  private Map<String, List<SchemaImport>> imports
  	= new HashMap<String, List<SchemaImport>>();
   ...
   */
  private List<SchemaReference> includes = new Vector<SchemaReference>();

  /*
   * redefines is a list of Redefine objects for the targetNamespace of the
   * enclosing schema. There is one Redefine in the List for each <redefine>
   * element in the XML Schema.
   */
  private List<SchemaReference> redefines = new Vector<SchemaReference>();
  ...
  public void addImport(SchemaImport importSchema)
  {
    ...
    List<SchemaImport> importList = this.imports.get(namespaceURI);
