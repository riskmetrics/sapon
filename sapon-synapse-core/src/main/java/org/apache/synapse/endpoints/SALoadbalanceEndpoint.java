...
public class SALoadbalanceEndpoint extends LoadbalanceEndpoint {
     ...
     */
    public void onChildEndpointFail(Endpoint endpoint, SynapseMessageContext synCtx) {
    ...
    * Helper method  that send message on the endpoint sequence on the current session
     */
    private void sendMessageOnCurrentSession(String sessionID, List<Endpoint> endpoints, SynapseMessageContext synCtx) {
     ...
     */
    private void sendMessageOnNewSession(SynapseMessageContext synCtx) {
    ...
    */
    private void prepareEndPointSequence(SynapseMessageContext synCtx, Endpoint endpoint) {
