...
public class DefaultAttachments implements Attachments {
     ...
     */
    TreeMap<String, DataHandler> attachmentsMap;
     ...
     * @throws OMException
     */
    public DefaultAttachments(	LifecycleManager manager, 
    	...
    	throws OMException 
    {
        ...
        attachmentsMap = new TreeMap<String, DataHandler>();
        try {
     ...
     * @throws OMException
     */
    public DefaultAttachments(	InputStream inStream, 
    							String contentTypeString,
    							boolean fileCacheEnable, 
    							String attachmentRepoDir,
    							String fileThreshold ) 
    ...
    public DataHandler getDataHandler(String blobContentID) {
        ...
        if (attachmentsMap.containsKey(blobContentID)) {
            dataHandler = attachmentsMap.get(blobContentID);
            return dataHandler;
        } else if (!noStreams) {
