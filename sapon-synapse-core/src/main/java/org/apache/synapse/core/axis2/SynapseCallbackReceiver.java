...
public class SynapseCallbackReceiver implements MessageReceiver {
    ...
    public SynapseCallbackReceiver(SynapseConfiguration synCfg) {
        ...
        callbackStore = Collections.synchronizedMap(new HashMap<String, AsyncCallback>());
    ...
    public void addCallback(String MsgID, AsyncCallback callback) {
...
//        }
    ...
    private void handleMessage(	String messageID,
    							...
    							SynapseMessageContext synapseOutMsgCtx )
    	throws AxisFault
    {
        ...
        if (o != null && Boolean.TRUE.equals(o)) {
            ...
            if (log.isDebugEnabled()) {
                ...
                String[] cids = response.getAttachments().getAllContentIDs();
            ...
            MessageContext axisOutMsgCtx =
                    ((Axis2SynapseMessageContext) synapseOutMsgCtx).getAxis2MessageContext();
            ...
            SynapseMessageContext synapseInMessageContext =
                    Axis2SynapseMessageContextImpl.newInstance(
                            response,
