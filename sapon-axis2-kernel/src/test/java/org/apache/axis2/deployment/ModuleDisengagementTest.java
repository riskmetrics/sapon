...
public class ModuleDisengagementTest extends TestCase {
	...
	protected void setUp() throws Exception {
        String filename =
                getClass().getResource("/deployment/moduleDisEngegeRepo").getFile();
    ...
    public void testGlobalDisengagement() throws AxisFault {
        ...
        Phase phase;
        Phase userPhase;
        List<Phase> globalinflow = config.getInFlowPhases();
        assertNotNull(globalinflow);
        phase = globalinflow.get(3);
        assertNotNull(phase);
        ...
        userPhase = operation.getRemainingPhasesInFlow().get(1);
