...
public class SafeObjectInputStream implements ObjectInput, ObjectStreamConstants {
     ...
     */
    public <K,V> HashMap<K,V> readHashMap() throws IOException  {
        HashMap<K,V> hashMap = new HashMap<K,V>();
        return (HashMap<K,V>)readMap(hashMap);
    }
     ...
     * @see SafeObjectOutputStream.writeMap()
     */
    public <K,V> Map<K,V> readMap(Map<K,V> map) throws IOException {
        ...
        while (in.readBoolean()) {
            ...
            try {
                if (isObjectForm) {
                    ...
                    key = (K)tempOIS.readObject();
                    value = (V)tempOIS.readObject();
                    tempOIS.close();
                    bais.close();
                }
    ...
    public <T> ArrayList<T> readArrayList() throws IOException {
        ...
        return (ArrayList<T>) readList(ll);
    }
     ...
     * @see SafeObjectInputStream.writeList()
     */
    public <T> LinkedList<T> readLinkedList() throws IOException {
       List<T> ll = new LinkedList<T>();
       return (LinkedList<T>) readList(ll);
    }
     ...
     * @see SafeObjectInputStream.writeList()
     */
    public <T> List<T> readList(List<T> list) throws IOException {
        boolean isActive = in.readBoolean();
        if (!isActive) {
            return null;
        }
