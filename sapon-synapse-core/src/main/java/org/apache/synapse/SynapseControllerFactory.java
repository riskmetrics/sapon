...
public class SynapseControllerFactory {
    ...
    private static SynapseController loadSynapseController(SynapseServerInfo information) {
     ...
     */
    private static void validate(SynapseServerInfo information) {
        ...
        if (information == null) {
            ...
            if (information.isCreateNewInstance()) {
                ...
                validatePath("axis2.xml location", information.getAxis2XmlLocation());
            }
