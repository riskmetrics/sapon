 ...
 * <p>
 *
 * @version $Rev: 725315 $ $Date: 2008-12-10 15:45:38 +0000 (Wed, 10 Dec 2008) $
 */
public class JarFileClassLoader extends MultiParentClassLoader {
    ...
    public JarFileClassLoader(URL[] urls, ClassLoader[] parents, boolean inverseClassLoading, Collection<String> hiddenClasses, Collection<String> nonOverridableClasses) {
	...
	protected String findLibrary(String libraryName) {
        ...
        ResourceHandle resourceHandle = AccessController.doPrivileged(
        		new PrivilegedAction<ResourceHandle>() {
